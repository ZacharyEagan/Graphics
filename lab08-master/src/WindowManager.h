...
public:
	...
	virtual void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos) = 0; //new3
...
private:
	...
	static void cursor_pos_callback(GLFWwindow *window, double xpos, double ypos); //new3
