...
public:
   ...
   //NEW3 Attempting color array
		...
		glBufferData(GL_ARRAY_BUFFER, sizeof(g_vertex_color_data),  
                   g_vertex_color_data, GL_DYNAMIC_DRAW);
	...
	********/
	void render()
	{
      ...
      //glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, IndexBufferID);
		...
		glDrawElements(GL_TRIANGLES, 9, GL_UNSIGNED_INT, nullptr);//NEW4
